...
public class myFullImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_full_image);
        verifyStoragePermissions(this);
        ZoomageView imageView = (ZoomageView) findViewById(R.id.myfullImage);
        Intent i = getIntent();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.myfullimage, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.delete:
                ...
                AlertDialog alert13 = builder2.create();
                alert13.show();
                return true;
            case R.id.share:
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(myFullImage.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            Toast.makeText(myFullImage.this,"Selected image downloaded!",Toast.LENGTH_LONG).show();
        }
        ...
        photoRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(myFullImage.this,"Selected image deleted!",Toast.LENGTH_LONG).show();
            }
        })
