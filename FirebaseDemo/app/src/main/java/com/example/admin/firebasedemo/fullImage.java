    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.report:
                ...
                intent.putExtra(Intent.EXTRA_EMAIL  , new String[]{"vanbac998@gmail.com"});
                intent.putExtra(Intent.EXTRA_SUBJECT, "Report image :"+ name);
                intent.putExtra(Intent.EXTRA_TEXT   , "I do not like this image, Please delete it!!\n Url: "+ img);
                try {
                    startActivity(Intent.createChooser(intent, "Send mail..."));
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(fullImage.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
                }
                return true;
            case R.id.share:
